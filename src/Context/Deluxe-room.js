...
const Deluxe = () => {
  ...
  const features = [
    ...
    { name: "TV with Sky Channels", icon: require("../assets/icons/tv.png") },
    {
      ...
      icon: require("../assets/icons/airco.png"),
    },
    ...
    { name: "Ironing Facilities", icon: require("../assets/icons/iron.png") },
    {
      ...
      icon: require("../assets/icons/toileries.png"),
    },
    {
  ...
  return (
    <div>
      ...
      <div className="details-container">
        ...
        <hr />
        <p>
          Our Deluxe Rooms come with a private balcony or patio overlooking a
          lush tropical garden. All rooms include air conditioning and heating,
          TV with Sky channels, mini fridge, tea and coffee making facilities,
          free WiFi, and are double-glazed. An en-suite bathroom comes with a
          hairdryer and complimentary toiletries. Rooms are located on the
          ground level or on the 1st floor.
        </p>
      ...
      <div className="let-check">
        ...
        <h4>
          Deluxe rooms are located close to the pool and other hotel facilities.
        ...
        <button className="check-button" onClick={handleCheckAvailabilityClick}>
          Check Availability
        </button>
      </div>
      <Roomc />
