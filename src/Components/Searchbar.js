...
function SearchBar() {
  ...
  const [isLocalGovtDropdownVisible, setIsLocalGovtDropdownVisible] = useState(false);
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      ...
      if (localGovtDropdownRef.current && !localGovtDropdownRef.current.contains(event.target)) {
